...
function Recipe() {
    return (
        <div>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 mt-6 mx-3">
                {[
                    {
                        ...
                        title: "Smoothie Bowl",
                        description:
                            "Ingredients: 2 frozen bananas, 1 cup frozen mixed berries, ½ cup almond milk. Recipe: Blend frozen bananas, berries, and almond milk until smooth and thick. Add granola, fresh fruit, and other toppings.",
                    },
                    {
                        ...
                        title: "Tasty Treat",
                        description:
                            "Ingredients: Lorem ipsum dolor sit amet. Recipe: Molestias explicabo corporis voluptatem?",
                    },
                    {
                        ...
                        title: "Yummy Delight",
                        description:
                            "Ingredients: Lorem ipsum dolor sit amet. Recipe: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel orci quis nulla ultricies volutpat.",
                    },
                ].map((recipe, index) => (
                    <article
                        key={index}
